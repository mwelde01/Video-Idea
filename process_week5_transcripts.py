#!/usr/bin/env python3
"""
Process Week 5 video transcripts.
...
Usage:
    python process_week5_transcripts.py
"""

import os
from extract_panopto_transcripts import extract_panopto_transcript

def parse_video_links(filepath='week5_video_links.txt'):
    ...
    # Process all lines (no header in week5 file)
    for line in lines:
        if not line.strip():
            continue
...
def process_all_videos(input_file='week5_video_links.txt', output_file='week5_transcripts.md'):
    """Process all Week 5 videos and compile transcripts"""

    print("="*80)
    print("WEEK 5: VIDEO TRANSCRIPT EXTRACTOR")
    print("="*80)
    print()
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("# Week 5: Video Transcripts\n\n")
    ...
    if success_count < total:
        ...
        print("3. Run: python add_week5_manual_transcripts.py")
        print()
